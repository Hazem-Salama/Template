    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-gray-900 to-red-900 pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            Drive growth through strategic digital marketing campaigns across all platforms. 
            From social media management to paid advertising, we deliver measurable results.
          </motion.p>
          ...
          >
            ...
            <Button 
              ...
              size="large"
              onClick={() => {
                const portfolioSection = document.getElementById('marketing-portfolio')
