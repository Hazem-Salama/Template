...
const TEMPLATE_CONFIG = {
  hero: {
    title: {
      highlight: 'UI/UX Design', // The highlighted part
      main: 'That Converts'
    },
    subtitle: 'Create intuitive user experiences that delight your customers, boost conversions, and drive sustainable business growth through strategic design.',
    services: [
    ...
    ctas: {
      primary: {
        ...
        url: '/contact?service=ui-ux-design'
      },
      secondary: {
        text: 'View Our Designs',
        scrollTarget: '#uiux-portfolio'
      }
    },
    stats: [
...
export default function UIUXHero() {
  const handleSecondaryClick = () => {
    const element = document.querySelector(TEMPLATE_CONFIG.hero.ctas.secondary.scrollTarget)
...
/* 
🎯 UNIFIED UI/UX HERO - TEMPLATE READY
...
4. Set CTA URLs and scroll targets
...
Perfect foundation for UI/UX service pages that matches your unified design system!
*/