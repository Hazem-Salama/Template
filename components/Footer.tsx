...
export default function Footer() {
  ...
  const footerLinks = {
    services: [
      ...
      { name: 'Digital Marketing', href: '/DM' },
    ],
    company: [
  ...
  // Template social links - replace with your actual social media
  const socialLinks = [
    { 
      name: 'LinkedIn', 
    ...
    { 
      name: 'Twitter', 
      href: 'https://twitter.com/your_agency', 
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              We transform ambitious businesses through strategic design, cutting-edge development, and data-driven marketing that delivers measurable results.
            </p>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-500 transition-colors text-gray-400 hover:text-white"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} Your Creative Agency. All rights reserved.
          </p>
          
          <div className="flex items-center space-x-6 text-sm text-gray-400">
            <span>Made with ❤️ for ambitious brands</span>
          </div>
        </div>
      </div>
